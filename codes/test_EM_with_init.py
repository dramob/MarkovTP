...
if __name__ == "__main__":
    ...
    affiche_image(
        "Image Originale",
        X,
        save_path=os.path.join(output_folder, "image_originale_test_em.png"),
    )
    ...
    affiche_image(
        "Image Bruitée",
        Y,
        save_path=os.path.join(output_folder, "image_bruitee_test_em.png"),
    )
    ...
    for idx, init in enumerate(initializations):
        ...
        results_csv_path = os.path.join(
            output_outputs_folder, f"em_results_initialization_{idx + 1}.csv"
        )
        ...
        plt.savefig(
            os.path.join(
                output_outputs_folder, f"evolution_probabilites_init_{idx + 1}.png"
            ),
            bbox_inches="tight",
        )
        plt.show()
        ...
        plt.savefig(
            os.path.join(
                output_outputs_folder, f"evolution_moyennes_init_{idx + 1}.png"
            ),
            bbox_inches="tight",
        )
        plt.show()
        ...
        plt.savefig(
            os.path.join(
                output_outputs_folder, f"evolution_ecarts_types_init_{idx + 1}.png"
            ),
            bbox_inches="tight",
        )
        plt.show()
    ...
    plt.savefig(
        os.path.join(output_outputs_folder, "evolution_probabilites_init_param.png"),
        bbox_inches="tight",
    )
    plt.show()
    ...
    plt.savefig(
        os.path.join(output_outputs_folder, "evolution_moyennes_init_param.png"),
        bbox_inches="tight",
    )
    plt.show()
    ...
    plt.savefig(
        os.path.join(output_outputs_folder, "evolution_ecarts_types_init_param.png"),
        bbox_inches="tight",
    )
    plt.show()
