...
if __name__ == "__main__":
    ...
    affiche_image(
        "Image Originale",
        X,
        save_path=os.path.join(output_folder, "image_originale.png"),
    )
    ...
    affiche_image(
        "Image Bruitée", Y, save_path=os.path.join(output_folder, "image_bruitee.png")
    )
    ...
    (
        ...
        sig1_list,
        sig2_list,
    ) = calc_EM(Y, p10, p20, m10, sig10, m20, sig20, nb_iterEM)
    ...
    plt.savefig(
        os.path.join(output_folder, "evolution_probabilites.png"), bbox_inches="tight"
    )
    plt.show()
    ...
    plt.savefig(
        os.path.join(output_folder, "evolution_moyennes.png"), bbox_inches="tight"
    )
    plt.show()
    ...
    plt.savefig(
        os.path.join(output_folder, "evolution_ecarts_types.png"), bbox_inches="tight"
    )
    plt.show()
