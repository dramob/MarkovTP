...
if __name__ == "__main__":
    ...
    plt.savefig(
        os.path.join(output_folder, "evolution_probabilites_test_em.png"),
        bbox_inches="tight",
    )
    plt.show()
    ...
    plt.savefig(
        os.path.join(output_folder, "evolution_moyennes_test_em.png"),
        bbox_inches="tight",
    )
    plt.show()
    ...
    plt.savefig(
        os.path.join(output_folder, "evolution_ecarts_types_test_em.png"),
        bbox_inches="tight",
    )
    plt.show()
